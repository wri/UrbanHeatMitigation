...
The experiment used to train the model is published in [Azure AI Gallery](https://gallery.cortanaintelligence.com/Experiment/Train-a-decision-forest-model-to-predict-surface-reflectivity-of-roofs "Azure AI Gallery"). Anyone with a Microsoft account can run this experiment and get the same model.
